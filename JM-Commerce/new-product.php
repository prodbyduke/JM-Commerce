...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    add_product($_POST["title"], $_POST["artist"], $_POST["genre"], $_POST["year"], $_POST["price"], $_POST["quantity"]);
    $file_parts = explode('.', $_FILES["userfile"]["name"]);
    $file_ext = "." . end($file_parts);
    $target_dir = "assets/covers/";
    $target_file = $target_dir . basename(get_last_id() . ".jpg");
...
<head>
    ...
    <title>New Product - JM Commerce</title>
                ...
                <div class="col-lg-5">
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                        ...
                        <select name="artist" required>
                            <?php echo get_artists(); ?>
                        </select><br /><a href="new-artist.php">New artist...</a><br /><br />
