...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    register($_POST["first_name"], $_POST["last_name"], $_POST["username"], $_POST["email"], $_POST["password"]);
}
?>
<html lang="en">
  ...
  <head>
    ...
    <title>Sign Up - JM Commerce</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="section-heading">
                        <h2>Sign Up</h2>
                        <span>Fill in with your information</span>
                    </div>
                    <form id="contact" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                        <div class="row">
                          <div class="col-lg-6">
                            <fieldset>
                              <input name="first_name" type="text" id="first_name" placeholder="First Name" required="true">
                            </fieldset><br/>
                          </div>
                          <div class="col-lg-6">
                            <fieldset>
                              <input name="last_name" type="text" id="last_name" placeholder="Last Name" required="true">
                            </fieldset><br/>
                          </div>
                          <div class="col-lg-12">
                            <fieldset>
                              <input name="username" type="text" id="username" placeholder="Username" required="true">
                            </fieldset><br/>
                          </div>
                          <div class="col-lg-12">
                            <fieldset>
                          ...
                          <div class="col-lg-12">
                            <fieldset>
                              <button type="submit" id="form-submit" class="main-dark-button">Go!</button>
                            </fieldset>
                          </div>
                        </div>
                      </form>
